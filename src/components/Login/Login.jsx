...
setIserror(error.message),setSubmitButton(false),  
  )
console.log(values)
    ...
    <p className={Style.line} >Embark on a Journey Beyond Boundaries – Explore, Dream, and Discover with Us!</p>
      ...
      <br/>
        ...
        <div className={Style.appLogo} >
          <img className={Style.images} onClick={handleGoogle} src="https://slackmojis.com/emojis/195-google/download"  />
          <img className={Style.images}  src="https://www.freeiconspng.com/thumbs/facebook-logo-png/facebook-logo-3.png" />
          <img className={Style.images}  src="https://twemoji.twitter.com/content/dam/twemoji-twitter/Twitter_Social_Icon_Circle_Color.png.twimg.1920.png"  />
        </div>
